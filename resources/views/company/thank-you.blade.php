...
<i class="fa fa-thumbs-o-up-5x"></i> fa-5x
          ...
          <p>If you have any questions,  please don't hesitate to email us at <b>support@sms.com</b>.</p>
              <p>Thanks for choosing Nestweaver SMS, and congratulations on getting covered!</p><br /><br />
          <a href="{!! URL('/') !!}" class="btn btn-large btn-info"><i class="glyphicon glyphicon-home"></i> Take Me Home</a>
					</center>
				</div>							
			</div>
		</div>				
