...
<div class="row clearfix"> 
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="txtlastname">  Short Name </label>
									<div class="col-sm-9">			
										<?php
								$company_id='';
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">	
										<?php
								$url='';
								if(isset($urldetails->url))
								{
									$url=$urldetails->url;
								}
?>
<?php $urls=DB::table('smsurl')->get(); ?>
<!--
...
@endforeach
								...
								<div class="form-group">
									...
									<div class="col-sm-9">							
										<?php
								$username='';
								if(isset($urldetails->username))
								{
									$username=$urldetails->username;
								}
								?>
								<input type="text" id="txtsendername" name='j[username]' placeholder="Username" class="col-xs-10" value='{{$username}}' required>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">	
										<?php
								$smspwd='';
								if(isset($urldetails->smspwd))
								{
									$smspwd=$urldetails->smspwd;
								}
								?>		
<input type="text" id="txtsendername" name='j[smspwd]' placeholder="Password" class="col-xs-10" value='{{$smspwd}}' required>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">	
										<?php
								$sendername='';
								if(isset($urldetails->sendername))
								{
									$sendername=$urldetails->sendername;
								}
								?>												 
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<?php
								$smscredit='';
								if(isset($urldetails->smscredit))
								{
									$smscredit=$urldetails->smscredit;
								}
								?>													 
										<input type="number" id="txtsmscredit" name='j[smscredit]' placeholder="SMS Credit" class="col-xs-10" value='{{$smscredit}}' required>
					...
					<input type="hidden" name="from" value="{{$where}}" >
								</div>
							</div>
						</div>
						<div class="row">
