...
<a href="{{url('addadminuser')}}"><i class="fa fa-plus-square" aria-hidden="true"></i>Add user </a>
</div>
    <!-- Main content -->
...
<td>@if($val->status==1)
      Active<!--<a href="{{url('admindeactive/'.$val->id)}}"><i class="fa fa-square-o" aria-hidden="true"></i></a> -->
      ...
      @endif
 					       ...
 					       <input type="hidden" value="adminuserlist" name="route">
      ...
      <td><a href="{{URL::to('deladminuser/'.$val->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></td>
